...
import { ChainId, CurrencyAmount, TradeType } from '@taraswap/sdk-core'
import JSBI from 'jsbi'
import { FeeAmount, Pool } from '@taraswap/v3-sdk'
import { WNATIVE_ON } from '../../../../../utils/tokens'
import { CacheMode, CachedRoute, CachedRoutes, UNI_MAINNET, USDC_MAINNET, V3Route } from '@taraswap/smart-order-router'
